...
private val dateEarly = LocalDateTime.of(2019, Month.MAY, 24, 14, 25).toDate()
private val dateMid = LocalDateTime.of(2020, Month.JULY, 31, 19, 50).toDate()
private val dateLate = LocalDateTime.of(2021, Month.FEBRUARY, 28, 23, 4).toDate()
